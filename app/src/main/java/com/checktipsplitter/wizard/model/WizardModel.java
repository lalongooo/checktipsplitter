...
public class WizardModel extends AbstractWizardModel {
    ...
    protected PageList onNewRootPageList() {
        ...
        return new PageList(
                ...
                new FreeTextPage(this, "¿Total de la cuenta?", "bill_amount", "Total de la cuenta", "Cuenta total", InputType.TYPE_CLASS_NUMBER | InputType.TYPE_NUMBER_FLAG_DECIMAL).setRequired(true).setKey(BILL_AMOUNT_KEY),
                ...
                new FreeTextPage(this, "Porcentaje de propina", "gratification__amount", "% Propina", "Porcentaje", InputType.TYPE_CLASS_NUMBER | InputType.TYPE_NUMBER_FLAG_DECIMAL).setRequired(true).setKey(GRATIFICATION_AMOUNT_KEY)
        );
    }
}